...
export interface PaginationProps
  extends MixinProps<"container", ComponentProps<"nav">>,
    ComponentProps<"nav"> {}
...
function PaginationLink({
  ...
  return (
    <Button
      variant={
        variant ??
        (boxed ? "ghost" : isActive ? "outline" : "ghost")
      }
      size={size}
      ...
      className={cn(
        boxed &&
          "size-9 border border-input bg-card text-foreground hover:bg-subtle hover:shadow-none data-[state=hover]:bg-subtle data-[state=hover]:shadow-none",
        boxed &&
          isActive &&
          "border-transparent bg-primary text-primary-foreground hover:bg-primary data-[state=hover]:bg-primary",
        boxed &&
