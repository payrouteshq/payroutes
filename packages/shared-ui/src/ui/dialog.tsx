    ...
    <DialogPortal>
      ...
      >
        <DialogPrimitive.Popup
          ...
          className={cn(
            "relative z-50 w-full max-w-md origin-(--transform-origin) rounded-xl border border-ring bg-popover p-6 text-popover-foreground shadow-elevation-md outline-hidden duration-100",
